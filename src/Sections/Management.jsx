...
const Management = () => {
    return (
        <div className="lg:h-auto bg-[#77846d] flex flex-col items-start lg:px-32 pb-20 p-3">
            <p className="appear mt-7 lg:mt-10 text-white text-[2.5rem] lg:text-7xl lg:ml-8 leading-[50px] font-medium">Management Council Members</p>
            ...
            <Swiper
                ...
                className='appear h-[400px] w-full bg-[#77846d] mt-8 lg:mt-20 gap-4'
            >
