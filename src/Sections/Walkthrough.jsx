  ...
  return (
    <>
        ...
        <div className='flex flex-col items-center -mt-[600px] z-10 gap-6 text-green-4'>
            <img src={logoBlack} className='h-56' />
            <p className='text-[4.2rem] font-semibold'>Geojit CUSAT Center Of Sustainability Studies</p>
            <p className='text-6xl font-semibold'>GCCOSS</p>
        </div>
    </>
