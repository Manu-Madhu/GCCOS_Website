...
const About2 = () => {
  return (
    <div className="lg:h-auto w-full flex flex-col lg:flex-row overflow-hidden lg:gap-4 lg:pb-10 lg:pr-10 p-3">
      ...
      <div className='flex flex-col mt-5 lg:mt-[100px]'>
        <div className='flex flex-row gap-5'>
          <div className='relative group overflow-hidden '>
            ...
            <div className='absolute inset-0 h-[493px] bottom-0 flex items-center rounded-lg justify-center 
            ...
            <p className='lg:text-2xl lg:mt-5'>Training & certifications</p>
          </div>

          <div className='relative group mt-16'>
            <img src={about3} className='hover:scale-105 duration-200 rounded-lg' />
            <div className='absolute inset-0 h-[493px] bottom-0 flex items-center rounded-lg justify-center bg-black bg-opacity-80 opacity-0 group-hover:opacity-100 duration-500 px-5'>
