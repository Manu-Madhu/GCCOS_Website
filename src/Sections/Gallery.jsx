...
const Gallery = () => {
  return (
    <>
        <video id='gallery' src={gif} autoPlay muted loop className='h-full w-full z-0'></video>
        <div className='flex flex-col items-center z-10 lg:-mt-[550px] duration-500 gap-24'>
