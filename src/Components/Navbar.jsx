        ...
        <div className="lg:h-full lg:w-full bg-green-3 lg:rounded-2xl">
            <div className="lg:flex lg:flex-row lg:items-center lg:justify-between lg:px-20 pt-3">
                <div className='lg:flex lg:flex-row lg:gap-7 text-white tracking-wide'>
                    ...
                    <a href="#about" className='lg:hover:text-gray-400'>About</a>
                    <a href="#gallery" className='lg:hover:text-gray-400'>Gallery</a>
                    <a href="#blogs" className='lg:hover:text-gray-400'>Blogs</a>
                </div>
                ...
                <button className="bg-[#fee48b] lg:w-32 lg:h-10 lg:rounded-3xl lg:hover:bg-green-3 lg:hover:border-2 border-black duration-300"><a href="#contact">Contact us</a></button>
            </div>
        </div>
    </div>
  )
